...
export const generatedSchema = {
  ...
  Category: {
    ...
    categoryColor: { __type: 'Category_Categorycolor' },
  ...
  [SchemaUnionsKey]: {
    ...
    AcfFieldGroup: ['Category_Categorycolor'],
...
export interface AcfFieldGroup {
  __typename?: 'Category_Categorycolor'
  /**
...
export interface Category {
  ...
  /**
   * Added to the GraphQL Schema because the ACF Field Group &quot;カテゴリー色&quot; was set to Show in GraphQL.
   */
  categoryColor?: Maybe<Category_Categorycolor>
  /**
 ...
 * Field Group
 */
export interface Category_Categorycolor {
  __typename?: 'Category_Categorycolor'
  /**
   * カテゴリー色
   */
...
export interface SchemaObjectTypes {
  ...
  Category_Categorycolor: Category_Categorycolor
  Comment: Comment
